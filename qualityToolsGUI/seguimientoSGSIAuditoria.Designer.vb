...
Partial Class seguimientoSGSIAuditoria
    ...
    Private Sub InitializeComponent()
        ...
        Me.Label7.Text = "5. Actualiza los planes de seguridad con base a las actividades de seguimiento y " & _
            "revisión."
        '
        'RadioButton9
        '
        ...
        Me.Label6.Text = "4. Realiza auditorias internas del SGSI a intervalos planificados."
        '
        'RadioButton7
        '
        ...
        Me.Label5.Text = "3. Mide periodicamente la eficacia de los controles para verificar que se cumplan" & _
        ...
        Me.Label3.Text = "2. Emprende revisiones regulares de la eficacia del SGSI."
        '
        'RadioButton5
        '
        ...
        Me.Label4.Text = "1. Ejecuta procedimientos de seguimiento y revisión para detectar errores, incide" & _
            "ntes e intentos de violación a la seguridad."
        '
        'Label2
        '
